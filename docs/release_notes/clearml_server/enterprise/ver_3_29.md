...
### Enterprise Server 3.29.4

**Bug Fixes and Improvements**
* Fix frame details not updating when navigating between frames and context IDs in the UI Hyper-Dataset Frame Viewer
* Improve security

### Enterprise Server 3.29.3
...
Starting with v3.29, server containers use updated permissions. To avoid permission issues, follow the required
upgrade steps for your deployment type:

* **Docker Compose deployments** - follow the [required upgrade steps](../../../deploying_clearml/enterprise_deploy/docker_compose_upgrade_3_29.md).
* **Helm chart deployments** - v3.29 ships in `clearml-enterprise` chart v11.0.0. Follow the
  [required upgrade steps](../../../deploying_clearml/enterprise_deploy/helm_upgrade_11_0.md).
:::

...
Tenant admins can view detailed usage and spend information through the [**Analytics**](../../../webapp/webapp_admin_dashboard.md#analytics) tab of the Admin Dashboard.

Platform maintainers can view tenant usage and spend information in the tenant page of the [platform management center](../../../platform_management_center.md).
...
* `clearml_tenant` - The tenant ID the event belongs to. You can find the tenant ID in the following places:
   * [Platform Management Center](../../../platform_management_center.md) tenant list (landing page). Click `ID`
...
* The [Analytics](../../../webapp/webapp_admin_dashboard.md#analytics) tab of the Admin Dashboard
* [Platform management center](../../../platform_management_center.md) UI tenant pages
